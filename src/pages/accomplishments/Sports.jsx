...
export default function AccomplishmentsSports() {
	return (
		<>
			<Seo title="Sports Accomplishments" />
			<PageBanner title="Sports Accomplishments" />
				...
				<div className="container" style={{ overflowX: "hidden" }}>
					<div className="row">
						<h2 className="mt-5 text-center fs-1" style={{ color: "#654f4f" }}>
							SARDAR PATEL KARATE CUP 2023, AHMEDABAD
						</h2>
						...
						<p>
							...
							Congratulations to the entire team on their remarkable success! Kabir, representing
							the third grade, earned a remarkable Gold medal.
							<br />
							Veer Sihag, representing the fourth grade, secured another impressive Gold medal.
							<br />
							Manya, a fifth-grade student, exhibited her talent and won a deserving Silver medal.
							<br />
							Harshal and Aarav&apos;s dedication earned them well-deserved Bronze medals.
						</p>
					</div>
					<div className="row">
